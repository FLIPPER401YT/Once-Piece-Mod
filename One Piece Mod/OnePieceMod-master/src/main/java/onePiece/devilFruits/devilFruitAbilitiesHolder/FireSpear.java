...
public class FireSpear extends CustomSpearToolItem
{
    String name;
    FireFruit fruit;

    public FireSpear(int d, Item.Rarity rarity, int animSpeed, int range, int knockBack, int enchantCost, FireFruit f)
    {
